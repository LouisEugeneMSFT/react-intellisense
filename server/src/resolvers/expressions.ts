...
export const buildInFunctionsMap: Map<string, FunctionEntity> = new Map<
  string,
  FunctionEntity
>([
  [
  ...
  */
  ...
  [
    ...
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is an integer number.'
    ),
  ],
  [
    'isFloat',
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is a float point number.'
    ),
  ],
  [
    'isBoolean',
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is a boolean.'
    ),
  ],
  [
    'isArray',
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is an array.'
    ),
  ],
  [
    'isObject',
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is an object.'
    ),
  ],
  [
    'isDateTime',
  ...
  [
    ...
    new FunctionEntity(
      ['input: any'],
      ReturnType.Boolean,
      'determine whether a given input is a string.'
    ),
  ],
